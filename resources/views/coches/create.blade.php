...
@endif
    <form name="c" method="POST" action="{{route('coches.store')}}" enctype="multipart/form-data">
        ...
        <div class="form-row mt-3">
            ...
            <div class="col">
                <input type="text" class="form-control" placeholder="Kilometros" name="klms" required>
            </div>
            <div class="col">
                <input type="number" class="form-control" placeholder="PVP (€)" name="pvp" step="0.50" min="100" required >
            </div>
        </div>
        <div class="form-row mt-3">
            <div class="col">
